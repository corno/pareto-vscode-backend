...
export const $$: _et.Refiner_Old<string, null, d.Seal_Parameters> = ($) => _ea.create_refinement_context<d_parse_tree._T_Document, d_parse_result.Parse_Error>((abort) => r_parse.Document(
	$.content,
	{
		'tab size': 1,
	},
