...
export const $$: _et.Query_Procedure<d.On_Completion_Result, d_load_pareto_document.Error, d.On_Completion_Parameters, Resources> = _easync.create_query_procedure(
