...
// import { $$ as load_pareto_document } from "pareto/dist/implementation/algorithms/queries/load_pareto_document"
...
// export const $$: _et.Query_Procedure<d.On_Hover_Parameters, d.On_Hover_Result, null, Resources> = (
// 	$r,
// ) => ($p) => load_pareto_document(
// 	{
// 		'content': $p.content,
...
// 	}
// })).catch_(($) => {
// 	return _easync.query['create result']({
// 		'contents': {
