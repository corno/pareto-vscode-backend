...
export const Diagnostic: t_signatures.Diagnostic = ($,) => ['group', ['verbose', _p.dictionary.literal(({
    ...
    'related information': _p.deprecated_cc($['related information'], ($,) => ['optional', $(($,) => ['set', ['list', $.__l_map(($,) => ['group', ['verbose', _p.dictionary.literal(({
    ...
    }))]])]], () => ['set', ['list', $.__l_map(($,) => ['group', ['verbose', _p.dictionary.literal(({
        'location': _p.deprecated_cc($['location'], ($,) => ['group', ['verbose', _p.dictionary.literal(({
            'file path': _p.deprecated_cc($['file path'], ($,) => ['text', ({
                'delimiter': ['quote', null],
                'value': $,
...
export const Optional_Hover_Texts: t_signatures.Optional_Hover_Texts = ($,) => ['optional', $(($,) => ['set', Hover_Texts($)], () => ['set', Hover_Texts($)])]
...
export const Optional_Completion_Items: t_signatures.Optional_Completion_Items = ($,) => ['optional', $(($,) => ['set', Completion_Items($)], () => ['set', Completion_Items($)])]
