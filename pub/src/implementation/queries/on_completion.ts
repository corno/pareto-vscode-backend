...
type Signature = _et.Query_Function<d.On_Completion_Result, d_load_pareto_document.Error, d.On_Completion_Parameters, Resources>

import { Signature as x } from "../../interface/algorithms/queries/on_completion"
